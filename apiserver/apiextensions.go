...
func createExtensionServer(
	...
	if err := apiEnablementOpts.ApplyTo(
		&genericConfig,
	...
	return apiextensionsConfig.Complete().New(genericapiserver.NewEmptyDelegate())
}
